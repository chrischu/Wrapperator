...
namespace Wrapperator.Wrappers.Diagnostics
{
  ...
  public class ProcessStaticWrapper : Wrapperator.Interfaces.Diagnostics.IProcessStatic
  {
    ...
    {
      return new Wrapperator.Wrappers.Diagnostics.ProcessWrapper(System.Diagnostics.Process.Start(startInfo == null ? default(System.Diagnostics.ProcessStartInfo) : ((Wrapperator.Wrappers.Diagnostics.ProcessStartInfoWrapper)startInfo).ProcessStartInfo));
    }
  }
}
