...
namespace Wrapperator.Wrappers
{
  ...
  public class DateTimeStaticWrapper : Wrapperator.Interfaces.IDateTimeStatic
  {
    ...
    {
      return System.DateTime.Compare(t1 == null ? default(System.DateTime) : t1._DateTime, t2 == null ? default(System.DateTime) : t2._DateTime);
    }
    ...
    {
      return new Wrapperator.Wrappers.DateTimeWrapper(System.DateTime.SpecifyKind(value == null ? default(System.DateTime) : value._DateTime, kind));
    }
