...
namespace Wrapperator.Wrappers.Xml.Linq
{
  ...
  public class XNodeStaticWrapper : Wrapperator.Interfaces.Xml.Linq.IXNodeStatic
  {
    ...
    {
      return System.Xml.Linq.XNode.CompareDocumentOrder(n1 == null ? default(System.Xml.Linq.XNode) : n1._XNode, n2 == null ? default(System.Xml.Linq.XNode) : n2._XNode);
    }
    ...
    {
      return new Wrapperator.Wrappers.Xml.Linq.XNodeWrapper(System.Xml.Linq.XNode.ReadFrom(reader == null ? default(System.Xml.XmlReader) : reader._XmlReader));
    }
    ...
    {
      return System.Xml.Linq.XNode.DeepEquals(n1 == null ? default(System.Xml.Linq.XNode) : n1._XNode, n2 == null ? default(System.Xml.Linq.XNode) : n2._XNode);
    }
  }
}
