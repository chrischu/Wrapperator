...
namespace Wrapperator.Wrappers.Xml.Linq
{
  ...
  public class XCommentWrapper : XNodeWrapper, Wrapperator.Interfaces.Xml.Linq.IXComment
  {
    ...
    {
      _XComment.WriteTo(writer == null ? default(System.Xml.XmlWriter) : writer._XmlWriter);
    }
    ...
    {
      return _XComment.Ancestors(name == null ? default(System.Xml.Linq.XName) : name._XName);
    }
    ...
    {
      return _XComment.ElementsAfterSelf(name == null ? default(System.Xml.Linq.XName) : name._XName);
    }
    ...
    {
      return _XComment.ElementsBeforeSelf(name == null ? default(System.Xml.Linq.XName) : name._XName);
    }
    ...
    {
      return _XComment.IsAfter(node == null ? default(System.Xml.Linq.XNode) : node._XNode);
    }
    ...
    {
      return _XComment.IsBefore(node == null ? default(System.Xml.Linq.XNode) : node._XNode);
    }
    ...
    {
      return _XComment.Annotation(type == null ? default(System.Type) : type._Type);
    }
    ...
    {
      return _XComment.Annotations(type == null ? default(System.Type) : type._Type);
    }
    ...
    {
      _XComment.RemoveAnnotations(type == null ? default(System.Type) : type._Type);
    }
