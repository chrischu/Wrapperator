...
namespace Wrapperator.Wrappers.Xml.Linq
{
  ...
  public class XDocumentTypeWrapper : XNodeWrapper, Wrapperator.Interfaces.Xml.Linq.IXDocumentType
  {
    ...
    {
      _XDocumentType.WriteTo(writer == null ? default(System.Xml.XmlWriter) : writer._XmlWriter);
    }
    ...
    {
      return _XDocumentType.Ancestors(name == null ? default(System.Xml.Linq.XName) : name._XName);
    }
    ...
    {
      return _XDocumentType.ElementsAfterSelf(name == null ? default(System.Xml.Linq.XName) : name._XName);
    }
    ...
    {
      return _XDocumentType.ElementsBeforeSelf(name == null ? default(System.Xml.Linq.XName) : name._XName);
    }
    ...
    {
      return _XDocumentType.IsAfter(node == null ? default(System.Xml.Linq.XNode) : node._XNode);
    }
    ...
    {
      return _XDocumentType.IsBefore(node == null ? default(System.Xml.Linq.XNode) : node._XNode);
    }
    ...
    {
      return _XDocumentType.Annotation(type == null ? default(System.Type) : type._Type);
    }
    ...
    {
      return _XDocumentType.Annotations(type == null ? default(System.Type) : type._Type);
    }
    ...
    {
      _XDocumentType.RemoveAnnotations(type == null ? default(System.Type) : type._Type);
    }
