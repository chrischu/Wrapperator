...
namespace Wrapperator.Wrappers.Xml.Linq
{
  ...
  public class XDocumentStaticWrapper : Wrapperator.Interfaces.Xml.Linq.IXDocumentStatic
  {
    ...
    {
      return new Wrapperator.Wrappers.Xml.Linq.XDocumentWrapper(System.Xml.Linq.XDocument.Load(stream == null ? default(System.IO.Stream) : stream._Stream));
    }
    ...
    {
      return new Wrapperator.Wrappers.Xml.Linq.XDocumentWrapper(System.Xml.Linq.XDocument.Load(stream == null ? default(System.IO.Stream) : stream._Stream, options));
    }
    ...
    {
      return new Wrapperator.Wrappers.Xml.Linq.XDocumentWrapper(System.Xml.Linq.XDocument.Load(textReader == null ? default(System.IO.TextReader) : textReader._TextReader));
    }
    ...
    {
      return new Wrapperator.Wrappers.Xml.Linq.XDocumentWrapper(System.Xml.Linq.XDocument.Load(textReader == null ? default(System.IO.TextReader) : textReader._TextReader, options));
    }
    ...
    {
      return new Wrapperator.Wrappers.Xml.Linq.XDocumentWrapper(System.Xml.Linq.XDocument.Load(reader == null ? default(System.Xml.XmlReader) : reader._XmlReader));
    }
    ...
    {
      return new Wrapperator.Wrappers.Xml.Linq.XDocumentWrapper(System.Xml.Linq.XDocument.Load(reader == null ? default(System.Xml.XmlReader) : reader._XmlReader, options));
    }
