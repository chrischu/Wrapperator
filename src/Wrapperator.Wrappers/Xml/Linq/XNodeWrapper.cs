...
namespace Wrapperator.Wrappers.Xml.Linq
{
  ...
  public class XNodeWrapper : XObjectWrapper, Wrapperator.Interfaces.Xml.Linq.IXNode
  {
    ...
    {
      return _XNode.Ancestors(name == null ? default(System.Xml.Linq.XName) : name._XName);
    }
    ...
    {
      return _XNode.ElementsAfterSelf(name == null ? default(System.Xml.Linq.XName) : name._XName);
    }
    ...
    {
      return _XNode.ElementsBeforeSelf(name == null ? default(System.Xml.Linq.XName) : name._XName);
    }
    ...
    {
      return _XNode.IsAfter(node == null ? default(System.Xml.Linq.XNode) : node._XNode);
    }
    ...
    {
      return _XNode.IsBefore(node == null ? default(System.Xml.Linq.XNode) : node._XNode);
    }
    ...
    {
      _XNode.WriteTo(writer == null ? default(System.Xml.XmlWriter) : writer._XmlWriter);
    }
    ...
    {
      return _XNode.Annotation(type == null ? default(System.Type) : type._Type);
    }
    ...
    {
      return _XNode.Annotations(type == null ? default(System.Type) : type._Type);
    }
    ...
    {
      _XNode.RemoveAnnotations(type == null ? default(System.Type) : type._Type);
    }
