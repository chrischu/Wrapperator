...
namespace Wrapperator.Wrappers.Xml.Linq
{
  ...
  public class XTextWrapper : XNodeWrapper, Wrapperator.Interfaces.Xml.Linq.IXText
  {
    ...
    {
      _XText.WriteTo(writer == null ? default(System.Xml.XmlWriter) : writer._XmlWriter);
    }
    ...
    {
      return _XText.Ancestors(name == null ? default(System.Xml.Linq.XName) : name._XName);
    }
    ...
    {
      return _XText.ElementsAfterSelf(name == null ? default(System.Xml.Linq.XName) : name._XName);
    }
    ...
    {
      return _XText.ElementsBeforeSelf(name == null ? default(System.Xml.Linq.XName) : name._XName);
    }
    ...
    {
      return _XText.IsAfter(node == null ? default(System.Xml.Linq.XNode) : node._XNode);
    }
    ...
    {
      return _XText.IsBefore(node == null ? default(System.Xml.Linq.XNode) : node._XNode);
    }
    ...
    {
      return _XText.Annotation(type == null ? default(System.Type) : type._Type);
    }
    ...
    {
      return _XText.Annotations(type == null ? default(System.Type) : type._Type);
    }
    ...
    {
      _XText.RemoveAnnotations(type == null ? default(System.Type) : type._Type);
    }
