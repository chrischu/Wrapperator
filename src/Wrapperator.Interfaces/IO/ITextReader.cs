...
namespace Wrapperator.Interfaces.IO
{
  ...
  public partial interface ITextReader : System.IDisposable
  {
    ...
    System.Threading.Tasks.Task<int> ReadAsync(char[] buffer, int index, int count);
    ...
    /// <exception cref="T:System.ObjectDisposedException">The text reader has been disposed.</exception>
    /// <exception cref="T:System.InvalidOperationException">The reader is currently in use by a previous read operation. </exception>
    System.Threading.Tasks.Task<int> ReadBlockAsync(char[] buffer, int index, int count);
