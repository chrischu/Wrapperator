...
namespace Wrapperator.Interfaces.IO
{
  ...
  public partial interface IDirectory
  {
    ...
    /// <filterpriority>1</filterpriority>
    Wrapperator.Interfaces.IO.IDirectoryInfo CreateDirectory(string path);
    ...
    ///  <paramref name="path" /> contains a colon character (:) that is not part of a drive label ("C:\").</exception>
    /// <filterpriority>1</filterpriority>
    Wrapperator.Interfaces.IO.IDirectoryInfo CreateDirectory(string path, System.Security.AccessControl.DirectorySecurity directorySecurity);
    ...
    /// <filterpriority>1</filterpriority>
    Wrapperator.Interfaces.IO.IDirectoryInfo GetParent(string path);
