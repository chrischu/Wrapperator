...
namespace Wrapperator.Interfaces.Xml.Schema
{
  ...
  public interface IXmlSchemaStatic
  {
    ...
    Wrapperator.Interfaces.Xml.Schema.IXmlSchema Read(Wrapperator.Interfaces.IO.ITextReader reader, System.Xml.Schema.ValidationEventHandler validationEventHandler);
    ...
    /// <exception cref="T:System.Xml.Schema.XmlSchemaException">An <see cref="T:System.Xml.Schema.XmlSchemaException" /> is raised if no <see cref="T:System.Xml.Schema.ValidationEventHandler" /> is specified.</exception>
    Wrapperator.Interfaces.Xml.Schema.IXmlSchema Read(Wrapperator.Interfaces.IO.IStream stream, System.Xml.Schema.ValidationEventHandler validationEventHandler);
    ...
    /// <param name="validationEventHandler">The validation event handler that receives information about the XML Schema syntax errors. </param>
    /// <exception cref="T:System.Xml.Schema.XmlSchemaException">An <see cref="T:System.Xml.Schema.XmlSchemaException" /> is raised if no <see cref="T:System.Xml.Schema.ValidationEventHandler" /> is specified.</exception>
    Wrapperator.Interfaces.Xml.Schema.IXmlSchema Read(Wrapperator.Interfaces.Xml.IXmlReader reader, System.Xml.Schema.ValidationEventHandler validationEventHandler);
  }
}
