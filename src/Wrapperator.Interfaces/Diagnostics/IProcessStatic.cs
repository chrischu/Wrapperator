...
namespace Wrapperator.Interfaces.Diagnostics
{
  ...
  public interface IProcessStatic
  {
    ...
    /// <filterpriority>1</filterpriority>
    Wrapperator.Interfaces.Diagnostics.IProcess GetProcessById(int processId, string machineName);
    ...
    /// <exception cref="T:System.InvalidOperationException">The process was not started by this object.</exception>
    /// <filterpriority>1</filterpriority>
    Wrapperator.Interfaces.Diagnostics.IProcess GetProcessById(int processId);
    ...
    /// <filterpriority>1</filterpriority>
    Wrapperator.Interfaces.Diagnostics.IProcess GetCurrentProcess();
    ...
    /// <filterpriority>1</filterpriority>
    Wrapperator.Interfaces.Diagnostics.IProcess Start(string fileName, string userName, System.Security.SecureString password, string domain);
    ...
    /// <exception cref="T:System.ObjectDisposedException">The process object has already been disposed. </exception>
    /// <filterpriority>1</filterpriority>
    Wrapperator.Interfaces.Diagnostics.IProcess Start(string fileName, string arguments, string userName, System.Security.SecureString password, string domain);
    ...
    /// <filterpriority>1</filterpriority>
    Wrapperator.Interfaces.Diagnostics.IProcess Start(string fileName);
    ...
    /// <exception cref="T:System.IO.FileNotFoundException">The PATH environment variable has a string containing quotes.</exception>
    /// <filterpriority>1</filterpriority>
    Wrapperator.Interfaces.Diagnostics.IProcess Start(string fileName, string arguments);
    ...
    /// <exception cref="T:System.ComponentModel.Win32Exception">An error occurred when opening the associated file. -or-The sum of the length of the arguments and the length of the full path to the process exceeds 2080. The error message associated with this exception can be one of the following: "The data area passed to a system call is too small." or "Access is denied."</exception>
    /// <filterpriority>1</filterpriority>
    Wrapperator.Interfaces.Diagnostics.IProcess Start(Wrapperator.Interfaces.Diagnostics.IProcessStartInfo startInfo);
  }
}
