...
namespace Wrapperator.Interfaces
{
  ...
  public interface ITypeStatic
  {
    ...
    /// <filterpriority>1</filterpriority>
    Wrapperator.Interfaces.IType ReflectionOnlyGetType(string typeName, bool throwIfNotFound, bool ignoreCase);
    ...
    /// <filterpriority>1</filterpriority>
    Wrapperator.Interfaces.IType GetTypeFromProgID(string progID);
    ...
    /// <filterpriority>1</filterpriority>
    Wrapperator.Interfaces.IType GetTypeFromProgID(string progID, bool throwOnError);
    ...
    /// <filterpriority>1</filterpriority>
    Wrapperator.Interfaces.IType GetTypeFromProgID(string progID, string server);
    ...
    /// <exception cref="T:System.Runtime.InteropServices.COMException">The specified progID is not registered. </exception>
    /// <filterpriority>1</filterpriority>
    Wrapperator.Interfaces.IType GetTypeFromProgID(string progID, string server, bool throwOnError);
    ...
    /// <filterpriority>1</filterpriority>
    Wrapperator.Interfaces.IType GetTypeFromCLSID(System.Guid clsid);
    ...
    /// <param name="throwOnError">true to throw any exception that occurs.-or- false to ignore any exception that occurs. </param>
    /// <filterpriority>1</filterpriority>
    Wrapperator.Interfaces.IType GetTypeFromCLSID(System.Guid clsid, bool throwOnError);
    ...
    /// <param name="server">The server from which to load the type. If the server name is null, this method automatically reverts to the local machine. </param>
    /// <filterpriority>1</filterpriority>
    Wrapperator.Interfaces.IType GetTypeFromCLSID(System.Guid clsid, string server);
    ...
    /// <param name="throwOnError">true to throw any exception that occurs.-or- false to ignore any exception that occurs. </param>
    /// <filterpriority>1</filterpriority>
    Wrapperator.Interfaces.IType GetTypeFromCLSID(System.Guid clsid, string server, bool throwOnError);
    ...
    /// <filterpriority>1</filterpriority>
    System.RuntimeTypeHandle GetTypeHandle(object o);
    ...
    /// <exception cref="T:System.Reflection.TargetInvocationException">A class initializer is invoked and throws an exception. </exception>
    /// <filterpriority>1</filterpriority>
    Wrapperator.Interfaces.IType GetTypeFromHandle(System.RuntimeTypeHandle handle);
    ...
    /// <filterpriority>1</filterpriority>
    System.Type[] GetTypeArray(object[] args);
  }
}
